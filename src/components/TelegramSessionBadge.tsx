...
export const TelegramSessionBadge: React.FC<TelegramSessionBadgeProps> = ({
  ...
  return (
    <div className="px-4 mb-2 select-none">
      <div className="flex items-center justify-between px-3.5 py-2 rounded-2xl ios-glass text-xs shadow-2xs">
        ...
        <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 font-semibold text-[10px] border border-blue-100">
